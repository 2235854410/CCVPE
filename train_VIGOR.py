...
parser.add_argument('--name', type=str, help='h', default='cross-GTretrain-fov')
...
parser.add_argument('--model_path', type=str, help='h', default='/data/test/code/CCVPE/ckpt/cross.pt')

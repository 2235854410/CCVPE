...
from model_dino import CVM_VIGOR_with_foundation_model as CVM
...
parser.add_argument('--pos_only', type=bool, default=True)
parser.add_argument('--name', type=str, help='experiment name', default='dino-slr-cross-0noise')
parser.add_argument('--infer_root', type=str, help='root path', default='/home/test/code/CCVPE/models/VIGOR/crossarea_HFoV360')
parser.add_argument('--model_path', type=str, help='used for infer', default='5/model_cross_triplet100_2024-11-26 16:44:02.pt')
...
wandb.init(project="CCVPE-finetune", name=args['name'], config=args)
print(args)
...
if training is True:
    ...
    test_dataloader = DataLoader(vigor, batch_size=batch_size, shuffle=False, num_workers=12)
...
if training:
    ...
    test_model_path = os.path.join(args['infer_root'], args['model_path'])

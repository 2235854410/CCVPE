...
class VigorDatasetTrain(Dataset):
    ...
    def __init__(self,
        ...
        for city in self.cities:
            ...
            if same_area:
                df_tmp = pd.read_csv(f'{data_folder}/splits__corrected/{city}/same_area_balanced_train__corrected.txt', header=None, delim_whitespace=True)
            else:
                df_tmp = pd.read_csv(f'{data_folder}/splits__corrected/{city}/pano_label_balanced__corrected.txt', header=None, delim_whitespace=True)
